...
class PublicationsFileApi(object):
    ...
    def create(self, file_file_publication, pulp_domain="default", **kwargs):  # noqa: E501
        """Create a file publication  # noqa: E501

        Trigger an asynchronous task to publish file content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(pulp_domain, file_file_publication, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.create_with_http_info(file_file_publication, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def create_with_http_info(self, file_file_publication, pulp_domain="default", **kwargs):  # noqa: E501
        """Create a file publication  # noqa: E501

        Trigger an asynchronous task to publish file content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(pulp_domain, file_file_publication, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/pulp/{pulp_domain}/api/v3/publications/file/file/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp/{pulp_domain}/api/v3/publications/file/file/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
