...
nested_role = pulpcore.client.pulp_file.NestedRole() # NestedRole | 
    ...
    try:
        # Add a role
        api_response = api_instance.add_role(file_file_remote_href, nested_role)
        pprint(api_response)
...
# **create**
> FileFileRemoteResponse create(pulp_domain, file_file_remote)
...
file_file_remote = pulpcore.client.pulp_file.FileFileRemote() # FileFileRemote | 
    ...
    try:
        # Create a file remote
        api_response = api_instance.create(pulp_domain, file_file_remote)
        pprint(api_response)
    except ApiException as e:
...
with pulpcore.client.pulp_file.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a file remote
        api_response = api_instance.delete(file_file_remote_href)
        pprint(api_response)
    except ApiException as e:
...
# **list_roles**
> ObjectRolesResponse list_roles(file_file_remote_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List roles
        api_response = api_instance.list_roles(file_file_remote_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
...
# **my_permissions**
> MyPermissionsResponse my_permissions(file_file_remote_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List user permissions
        api_response = api_instance.my_permissions(file_file_remote_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
...
patchedfile_file_remote = pulpcore.client.pulp_file.PatchedfileFileRemote() # PatchedfileFileRemote | 
    ...
    try:
        # Update a file remote
        api_response = api_instance.partial_update(file_file_remote_href, patchedfile_file_remote)
        pprint(api_response)
    except ApiException as e:
...
# **read**
> FileFileRemoteResponse read(file_file_remote_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Inspect a file remote
        api_response = api_instance.read(file_file_remote_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
...
nested_role = pulpcore.client.pulp_file.NestedRole() # NestedRole | 
    ...
    try:
        # Remove a role
        api_response = api_instance.remove_role(file_file_remote_href, nested_role)
        pprint(api_response)
    except ApiException as e:
...
set_label = pulpcore.client.pulp_file.SetLabel() # SetLabel | 
    ...
    try:
        # Set a label
        api_response = api_instance.set_label(file_file_remote_href, set_label)
        pprint(api_response)
    except ApiException as e:
...
unset_label = pulpcore.client.pulp_file.UnsetLabel() # UnsetLabel | 
    ...
    try:
        # Unset a label
        api_response = api_instance.unset_label(file_file_remote_href, unset_label)
        pprint(api_response)
    except ApiException as e:
...
file_file_remote = pulpcore.client.pulp_file.FileFileRemote() # FileFileRemote | 
    ...
    try:
        # Update a file remote
        api_response = api_instance.update(file_file_remote_href, file_file_remote)
        pprint(api_response)
    except ApiException as e:
