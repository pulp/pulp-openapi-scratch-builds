...
with pulpcore.client.pulp_gem.ApiClient(configuration) as api_client:
    ...
    try:
        # Add a role
        api_response = api_instance.add_role(gem_gem_publication_href, nested_role)
...
# **create**
> AsyncOperationResponse create(pulp_domain, gem_gem_publication)
...
with pulpcore.client.pulp_gem.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a gem publication
        api_response = api_instance.create(pulp_domain, gem_gem_publication)
...
# **list_roles**
> ObjectRolesResponse list_roles(gem_gem_publication_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulp_gem.ApiClient(configuration) as api_client:
    ...
    try:
        # List roles
        api_response = api_instance.list_roles(gem_gem_publication_href, fields=fields, exclude_fields=exclude_fields)
...
# **my_permissions**
> MyPermissionsResponse my_permissions(gem_gem_publication_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulp_gem.ApiClient(configuration) as api_client:
    ...
    try:
        # List user permissions
        api_response = api_instance.my_permissions(gem_gem_publication_href, fields=fields, exclude_fields=exclude_fields)
...
# **read**
> GemGemPublicationResponse read(gem_gem_publication_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulp_gem.ApiClient(configuration) as api_client:
    ...
    try:
        # Inspect a gem publication
        api_response = api_instance.read(gem_gem_publication_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulp_gem.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove a role
        api_response = api_instance.remove_role(gem_gem_publication_href, nested_role)
