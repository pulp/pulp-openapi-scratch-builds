...
class DistributionsOstreeApi(object):
    ...
    def create(self, ostree_ostree_distribution, pulp_domain="default", **kwargs):  # noqa: E501
        """Create an ostree distribution  # noqa: E501

        Trigger an asynchronous create task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(pulp_domain, ostree_ostree_distribution, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.create_with_http_info(ostree_ostree_distribution, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def create_with_http_info(self, ostree_ostree_distribution, pulp_domain="default", **kwargs):  # noqa: E501
        """Create an ostree distribution  # noqa: E501

        Trigger an asynchronous create task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(pulp_domain, ostree_ostree_distribution, async_req=True)
        >>> result = thread.get()
