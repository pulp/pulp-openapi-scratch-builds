...
class ContentContentApi(object):
    ...
    def create(self, ostree_ostree_content, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(pulp_domain, ostree_ostree_content, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_with_http_info(ostree_ostree_content, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def create_with_http_info(self, ostree_ostree_content, pulp_domain="default", **kwargs):  # noqa: E501
        """Create an ostree content  # noqa: E501

        Trigger an asynchronous task to create content,optionally create new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(pulp_domain, ostree_ostree_content, async_req=True)
        >>> result = thread.get()
