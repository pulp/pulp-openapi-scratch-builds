...
class RepositoriesApi:
    ...
    def list(
        ...
        pulp_type: Annotated[Optional[StrictStr], Field(description="Pulp type  * `core.openpgp` - core.openpgp * `file.file` - file.file * `rpm.rpm` - rpm.rpm * `ostree.ostree` - ostree.ostree")] = None,
        pulp_type__in: Annotated[Optional[List[StrictStr]], Field(description="Multiple values may be separated by commas.  * `core.openpgp` - core.openpgp * `file.file` - file.file * `rpm.rpm` - rpm.rpm * `ostree.ostree` - ostree.ostree")] = None,
        ...
        :param pulp_type: Pulp type  * `core.openpgp` - core.openpgp * `file.file` - file.file * `rpm.rpm` - rpm.rpm * `ostree.ostree` - ostree.ostree
        :type pulp_type: str
        :param pulp_type__in: Multiple values may be separated by commas.  * `core.openpgp` - core.openpgp * `file.file` - file.file * `rpm.rpm` - rpm.rpm * `ostree.ostree` - ostree.ostree
