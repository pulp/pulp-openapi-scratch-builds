...
class DistributionsApi(object):
    ...
    def list(self, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        :param str pulp_type: Pulp type  * `core.artifact` - core.artifact * `ostree.ostree` - ostree.ostree * `rpm.rpm` - rpm.rpm * `file.file` - file.file
        :param list[str] pulp_type__in: Multiple values may be separated by commas.  * `core.artifact` - core.artifact * `ostree.ostree` - ostree.ostree * `rpm.rpm` - rpm.rpm * `file.file` - file.file
        :param str q:
