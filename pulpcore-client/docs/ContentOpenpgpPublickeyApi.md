...
------------- | ------------- | -------------
[**create**](ContentOpenpgpPublickeyApi.md#create) | **POST** /api/pulp/{pulp_domain}/api/v3/content/core/openpgp_publickey/ | Create an open pgp public key
[**list**](ContentOpenpgpPublickeyApi.md#list) | **GET** /api/pulp/{pulp_domain}/api/v3/content/core/openpgp_publickey/ | List open pgp public keys
...
# **read**
> OpenPGPPublicKeyResponse read(open_p_g_p_public_key_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Inspect an open pgp public key
        api_response = api_instance.read(open_p_g_p_public_key_href, fields=fields, exclude_fields=exclude_fields)
