...
[**login_read**](LoginApi.md#login_read) | **GET** /api/pulp/{pulp_domain}/api/v3/login/ | 
[**logout**](LoginApi.md#logout) | **DELETE** /api/pulp/{pulp_domain}/api/v3/login/ | 


# **login**
> LoginResponse login(pulp_domain)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.login(pulp_domain)
...
# **login_read**
> LoginResponse login_read(pulp_domain, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.login_read(pulp_domain, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.logout(pulp_domain)
    except Exception as e:
