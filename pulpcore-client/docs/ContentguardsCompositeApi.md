...
[**create**](ContentguardsCompositeApi.md#create) | **POST** /api/pulp/{pulp_domain}/api/v3/contentguards/core/composite/ | Create a composite content guard
[**delete**](ContentguardsCompositeApi.md#delete) | **DELETE** {composite_content_guard_href} | Delete a composite content guard
[**list**](ContentguardsCompositeApi.md#list) | **GET** /api/pulp/{pulp_domain}/api/v3/contentguards/core/composite/ | List composite content guards
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Add a role
        api_response = api_instance.add_role(composite_content_guard_href, nested_role)
...
# **create**
> CompositeContentGuardResponse create(pulp_domain, composite_content_guard)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a composite content guard
        api_response = api_instance.create(pulp_domain, composite_content_guard)
...
# **list_roles**
> ObjectRolesResponse list_roles(composite_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # List roles
        api_response = api_instance.list_roles(composite_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
# **my_permissions**
> MyPermissionsResponse my_permissions(composite_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # List user permissions
        api_response = api_instance.my_permissions(composite_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a composite content guard
        api_response = api_instance.partial_update(composite_content_guard_href, patched_composite_content_guard)
...
# **read**
> CompositeContentGuardResponse read(composite_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Inspect a composite content guard
        api_response = api_instance.read(composite_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove a role
        api_response = api_instance.remove_role(composite_content_guard_href, nested_role)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a composite content guard
        api_response = api_instance.update(composite_content_guard_href, composite_content_guard)
