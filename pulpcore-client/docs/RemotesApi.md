...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    pulp_type = 'pulp_type_example' # str | Pulp type  * `file.file` - file.file * `rpm.rpm` - rpm.rpm * `rpm.uln` - rpm.uln * `ostree.ostree` - ostree.ostree (optional)
    pulp_type__in = ['pulp_type__in_example'] # List[str] | Multiple values may be separated by commas.  * `file.file` - file.file * `rpm.rpm` - rpm.rpm * `rpm.uln` - rpm.uln * `ostree.ostree` - ostree.ostree (optional)
 ...
 **pulp_type** | **str**| Pulp type  * &#x60;file.file&#x60; - file.file * &#x60;rpm.rpm&#x60; - rpm.rpm * &#x60;rpm.uln&#x60; - rpm.uln * &#x60;ostree.ostree&#x60; - ostree.ostree | [optional] 
 **pulp_type__in** | [**List[str]**](str.md)| Multiple values may be separated by commas.  * &#x60;file.file&#x60; - file.file * &#x60;rpm.rpm&#x60; - rpm.rpm * &#x60;rpm.uln&#x60; - rpm.uln * &#x60;ostree.ostree&#x60; - ostree.ostree | [optional] 
