...
pulp_type = 'pulp_type_example' # str | Pulp type  * `core.artifact` - core.artifact * `ostree.ostree` - ostree.ostree * `rpm.rpm` - rpm.rpm * `file.file` - file.file (optional)
pulp_type__in = ['pulp_type__in_example'] # list[str] | Multiple values may be separated by commas.  * `core.artifact` - core.artifact * `ostree.ostree` - ostree.ostree * `rpm.rpm` - rpm.rpm * `file.file` - file.file (optional)
 ...
 **pulp_type** | **str**| Pulp type  * &#x60;core.artifact&#x60; - core.artifact * &#x60;ostree.ostree&#x60; - ostree.ostree * &#x60;rpm.rpm&#x60; - rpm.rpm * &#x60;file.file&#x60; - file.file | [optional] 
 **pulp_type__in** | [**list[str]**](str.md)| Multiple values may be separated by commas.  * &#x60;core.artifact&#x60; - core.artifact * &#x60;ostree.ostree&#x60; - ostree.ostree * &#x60;rpm.rpm&#x60; - rpm.rpm * &#x60;file.file&#x60; - file.file | [optional] 
 **q** | **str**|  | [optional] 
