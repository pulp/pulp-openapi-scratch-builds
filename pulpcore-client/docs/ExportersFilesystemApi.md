...
# **create**
> FilesystemExporterResponse create(pulp_domain, filesystem_exporter)
...
filesystem_exporter = pulpcore.client.pulpcore.FilesystemExporter() # FilesystemExporter | 
    ...
    try:
        # Create a filesystem exporter
        api_response = api_instance.create(pulp_domain, filesystem_exporter)
        pprint(api_response)
