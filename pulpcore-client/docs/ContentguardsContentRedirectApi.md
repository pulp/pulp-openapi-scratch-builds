...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Add a role
        api_response = api_instance.add_role(content_redirect_content_guard_href, nested_role)
...
# **create**
> ContentRedirectContentGuardResponse create(pulp_domain, content_redirect_content_guard)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a content redirect content guard
        api_response = api_instance.create(pulp_domain, content_redirect_content_guard)
...
# **list_roles**
> ObjectRolesResponse list_roles(content_redirect_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # List roles
        api_response = api_instance.list_roles(content_redirect_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
# **my_permissions**
> MyPermissionsResponse my_permissions(content_redirect_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # List user permissions
        api_response = api_instance.my_permissions(content_redirect_content_guard_href, fields=fields, exclude_fields=exclude_fields)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove a role
        api_response = api_instance.remove_role(content_redirect_content_guard_href, nested_role)
