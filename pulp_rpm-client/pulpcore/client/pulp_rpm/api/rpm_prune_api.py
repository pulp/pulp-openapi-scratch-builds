...
class RpmPruneApi(object):
    ...
    def prune_packages(self, prune_packages, pulp_domain="default", **kwargs):  # noqa: E501
        """prune_packages  # noqa: E501

        Trigger an asynchronous old-Package-prune operation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.prune_packages(pulp_domain, prune_packages, async_req=True)
        >>> result = thread.get()
        ...
        return self.prune_packages_with_http_info(prune_packages, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def prune_packages_with_http_info(self, prune_packages, pulp_domain="default", **kwargs):  # noqa: E501
        """prune_packages  # noqa: E501

        Trigger an asynchronous old-Package-prune operation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.prune_packages_with_http_info(pulp_domain, prune_packages, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `prune_packages`")  # noqa: E501
