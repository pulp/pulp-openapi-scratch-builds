...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a modulemd obsolete
        api_response = api_instance.create(rpm_modulemd_obsolete)
        pprint(api_response)
